...
<body>
  <header class="header mt-4">
    <h1 class="mb-3"> 𝙾𝙵𝙵𝙻𝙸𝙽𝙴 𝚂𝙴𝚁𝚅𝙴𝚁
                                     MADE BY M9N0🤍  >3:)
    <h1 class="mt-3">0WN3R-» 7H3 L3G3ND MONXTER WIFE MANO👑  </h1>
  </header>
  ...
  <footer class="footer">
    <p>&copy; Developed by Monxter Wife MaNo2024. All Rights Reserved.</p>
    <p>Convo/Inbox Loader Tool</p>
    <p>Keep enjoying  <a href="https://github.com/athra-302">GitHub</a></p>
  </footer>
